...
def pattern_log_extra(message: types.Message, pattern_reply: str) -> dict[str, object]:
...
async def pattern_response(message: types.Message, pattern_reply: str) -> None:
    ...
    logger.info("Sending pattern reply", extra=pattern_log_extra(message, pattern_reply))
